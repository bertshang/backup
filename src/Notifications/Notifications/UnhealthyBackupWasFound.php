...
namespace Bertshang\Backup\Notifications\Notifications;

use Bertshang\Backup\Notifications\BaseNotification;
use Illuminate\Notifications\Messages\MailMessage;
use Illuminate\Notifications\Messages\SlackMessage;
use Illuminate\Notifications\Messages\SlackAttachment;
use Bertshang\Backup\Events\UnhealthyBackupWasFound as UnhealthyBackupWasFoundEvent;

class UnhealthyBackupWasFound extends BaseNotification
{
    /** @var \Bertshang\Backup\Events\UnhealthyBackupWasFound */
    protected $event;
