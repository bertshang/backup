...
namespace Bertshang\Backup\BackupDestination;

use Exception;
use Carbon\Carbon;
use Illuminate\Contracts\Filesystem\Factory;
use Illuminate\Contracts\Filesystem\Filesystem;
use Bertshang\Backup\Exceptions\InvalidBackupDestination;
...
class BackupDestination
{
    ...
    /** @var null|\Bertshang\Backup\BackupDestination\BackupCollection */
