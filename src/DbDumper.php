...
namespace Bertshang\Backup\DbDumper;

use Symfony\Component\Process\Process;
use Bertshang\Backup\DbDumper\Exceptions\DumpFailed;
use Bertshang\Backup\DbDumper\Compressors\Compressor;
use Bertshang\Backup\DbDumper\Compressors\GzipCompressor;
use Bertshang\Backup\DbDumper\Exceptions\CannotSetParameter;
use DB;
abstract class DbDumper
{
     ...
     * @return $this
     *
     * @throws \Bertshang\Backup\DbDumper\Exceptions\CannotSetParameter
     */
