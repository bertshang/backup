...
namespace Bertshang\Backup\Tasks\Cleanup\Strategies;

use Carbon\Carbon;
use Illuminate\Support\Collection;
use Bertshang\Backup\Tasks\Cleanup\Period;
use Bertshang\Backup\BackupDestination\Backup;
use Bertshang\Backup\Tasks\Cleanup\CleanupStrategy;
use Bertshang\Backup\BackupDestination\BackupCollection;

class DefaultStrategy extends CleanupStrategy
{
    /** @var \Bertshang\Backup\BackupDestination\Backup */
